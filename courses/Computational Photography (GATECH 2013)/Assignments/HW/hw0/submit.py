...
def submit():   
  print '==\n== [comphhoto] Submitting Solutions \n=='
...
partIds = ['splitrgb', 'interlace', 'greyscale']                        
# used to generate readable run-time information for students
partFriendlyNames = ['Split image into channels', 'Interlace rows of images.', 'Convert image to greyscale.'] 
# source files to collect (just for our records)
sourceFiles = ['part0.py', 'part1.py', 'part2.py']                           
