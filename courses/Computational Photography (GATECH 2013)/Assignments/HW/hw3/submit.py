...
partIds = ['reduce_expand', 'gauss_lapl_pyr', 'blend_collapse']                        
# used to generate readable run-time information for students
partFriendlyNames = ['reduce and expand functions', \
    'gaussian and laplacian pyramids', 'blend and collapse functions'] 
