...
partIds = ['volume_ssd', 'diff2', 'loop_synth']                        
# used to generate readable run-time information for students
partFriendlyNames = ['create video volume and find the frame ssd', \
    'find dynamic difference matrix', 'find biggest loop and synthesize it'] 
# source files to collect (just for our records)
sourceFiles = ['part0.py', 'part1.py', 'part2.py', 'run.py']                           
