...
URL = 'textanalytics-001'

partIds = ['N5CEfVap','04fgL7h3','kBW96sGk','N9T8NHdt']                        

partFriendlyNames = ['Task 1', 'Task 2', 'Task 3', 'Task 4'] 

sourceFiles = ['doc.pos-tagged.txt', 'mutual-information.txt', 'plsa.txt', 'competition.txt']                        
...
def output(partIdx):
  ...
  if partIdx == 0:
    ...
    for line in infile:
      ...
      infile = open("mutual-information.txt")
      for line in infile:
        outputString += line

  elif partIdx == 2:
      infile = open("plsa.txt")
      for line in infile:
        outputString += line

  elif partIdx == 3:
      infile = open("competition.txt")
      for line in infile:
        outputString += line
