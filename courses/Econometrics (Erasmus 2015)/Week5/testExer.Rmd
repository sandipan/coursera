...
* (c) Consider again the *odds ratio* positive response versus negative response: 
  ...
  setwd('C:/courses/Coursera/Current/Econometrics/Week5')
  df <- read.csv('Data Lecture 5-5.csv')
  df <- df[-1]
  m <- glm(response~.+I((age/10)^2), df, family='binomial')
  #summary(m)
  m <- glm(response~.+I((age/10)^2)+male:age, df, family='binomial')
  summary(m)
  ```
